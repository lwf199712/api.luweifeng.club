...
class RandChinaName
{
    ...
    {
        $this->arrXing = ['赵', '钱', '孙', '李', '周', '吴', '郑', '王', '冯', '陈', '褚', '卫', '蒋', '沈', '韩', '杨',
    ...
    {
        $this->arrMing = ['伟', '刚', '勇', '毅', '俊', '峰', '强', '军', '平', '保', '东', '文', '辉', '力', '明', '永',
    ...
    {
        return $this->arrXing [random_int(0, $this->numbXing)];
    }

    private function getMing()
    {
        return $this->arrMing [random_int(0, $this->numbMing)];
    }
